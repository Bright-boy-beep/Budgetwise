...
function _buildReportPreview(monthStr) {
  ...
  if (monthTxs.length > 0 && obs.length === 0) {
    obs.push(`No budget targets were set for this period. Setting monthly budgets allows Expense Tracker to track and report on spending adherence.`);
  }
  ...
  container.innerHTML = `
    <div id="report-printable" class="report-printable">
      ...
      <div class="rpt-header">
        <div class="rpt-brand">
          <img src="assets/images/logo-mark.svg" alt="Expense Tracker"
          ...
          <div style="display:inline-block;vertical-align:middle">
            <div class="rpt-brand-name">Expense Tracker</div>
      ...
      <div class="rpt-footer">
        ...
        <span>Generated by Expense Tracker on ${generated}</span>
      </div>
      <div class="rpt-disclaimer">
        This report is generated automatically from transaction data entered into Expense Tracker and is intended for personal financial reference only.
...
async function downloadReport() {
  ...
  try {
    ...
    const slug = new Date(y, m - 1)
      ...
      .replace(/\s+/g, '-');
    pdf.save(`Expense Tracker-Report-${slug}.pdf`);
